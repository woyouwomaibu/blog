...
;(function (exports, shared, vueDemi) {
  ...
  function asyncComputed(evaluationCallback, initialState, optionsOrRef) {
      ...
      const { lazy = false, evaluating = undefined, onError = shared.noop, } = options;
  ...
  function useRefHistory(source, options = {}) {
      ...
      const { eventFilter: composedFilter, pause, resume: resumeTracking, isActive: isTracking, } = shared.pausableFilter(eventFilter);
      const { ignoreUpdates, ignorePrevAsyncUpdates, stop, } = shared.ignorableWatch(source, commit, { deep, flush, eventFilter: composedFilter });
  ...
  function useDraggable(target, options = {}) {
      ...
      const position = vueDemi.ref((_b = options.initialValue) !== null && _b !== void 0 ? _b : { x: 0, y: 0 });
      ...
      return Object.assign(Object.assign({}, shared.toRefs(position)), { position, isDragging: vueDemi.computed(() => !!pressedDelta.value), style: vueDemi.computed(() => `left:${position.value.x}px;top:${position.value.y}px;`) });
  }
  ...
  ***************************************************************************** */
  ...
  function isFetchOptions(obj) {
      return shared.containsProp(obj, 'immediate', 'refetch', 'initialData', 'beforeFetch', 'afterFetch');
  }
  ...
  function usePointer(options = {}) {
      ...
      return Object.assign(Object.assign({}, shared.toRefs(state)), { isInside });
  }
  ...
  function useScroll(element, options = {}) {
      const { throttle = 0, idle = 200, onStop = shared.noop, onScroll = shared.noop, eventListenerOptions = {
          capture: false,
          passive: true,
      }, } = options;
      const x = vueDemi.ref(0);
      ...
      if (element) {
          ...
          useEventListener(element, 'scroll', throttle
              ? shared.useThrottleFn(onScrollHandler, throttle)
  ...
  function useVirtualList(list, options) {
      ...
      vueDemi.watch([size.width, size.height], () => {
          calculateRange();
      });
